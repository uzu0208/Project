        ...
        <tbody>
            ...
            <c:forEach var="list" items="${pagedto.list}">
                ...
                <tr>
                    ...
                    <td>${fstvlEndDate}</td>
                    <td title="${list.fstvlCo}">${list.fstvlCo}</td>
                    <td title="${list.mnnst}">${list.mnnst}</td>
                    <td title="${list.auspcInstt}">${list.auspcInstt}</td>
                    <td title="${list.suprtInstt}">${list.suprtInstt}</td>
                    <td title="${list.phoneNumber}">${list.phoneNumber}</td>
                    <td title="${list.homepageUrl}">${list.homepageUrl}</td>
                    <td title="${list.relateInfo}">${list.relateInfo}</td>
                    <td title="${list.rdnmadr}">${list.rdnmadr}</td>
                    <td title="${list.lnmadr}">${list.lnmadr}</td>
                    <td title="${list.latitude}">${list.latitude}</td>
                    <td title="${list.longitude}">${list.longitude}</td>
                    <td><fmt:formatDate value="${referenceDate}" pattern="yyyy-MM-dd"/></td>
                    <td>${list.insttCode}</td>
