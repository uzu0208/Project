...
<div class="card col-6 text-bg-light" style="float: none; margin:0 auto; padding:20px;">
            ...
            <form class="php-email-form aos-init aos-animate m-2" id="memberForm">
                    ...
                    <div class="form-group col-auto">
                    	  ...
                    	  <div class="row">
						    	<label for="userid" class="form-label"><strong>아이디</strong></label><br>
                    	  		<div class="col-auto">
                        		<input type="text" class="form-control" name="userid" id="userid" oninput="checkMaxLengthInput(this, 20)">
						  		</div>
						  		<div class="col-auto">
                ...
                <div class="row">
                    <div class="form-group col-auto my-2">
                        ...
                        <input type="password" name="password" class="form-control" id="password" oninput="checkMaxLengthInput(this, 20)">
                        <small class="form-text text-muted">최대 20자</small>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-auto my-2">
                        ...
                        <input type="password" name="password2" class="form-control" id="password2" oninput="checkMaxLengthInput(this, 20)">
                ...
                <div class="row">
                    <div class="form-group col-auto">
                        ...
                        <input type="text" name="username" class="form-control" oninput="checkMaxLengthInput(this, 20)" id="username">
                    </div>
                </div>
                <div class="row">
                    <div class="form-group my-2">
                        ...
                        <div class="row">
                            ...
                            <div class="col">
                                <button class="btn btn-warning" type="button" onclick="sample4_execDaumPostcode()">우편번호 찾기</button>
                            </div>
                        </div>
