...
public class MapController {
	...
	@GetMapping("/toCity")
	// http://localhost:8090/app/main
	public String toCity(Model m, @RequestParam(value = "citykey", required = false ) String citykey, @RequestParam(value = "curPage", required = false, defaultValue = "1") int curPage ) {
