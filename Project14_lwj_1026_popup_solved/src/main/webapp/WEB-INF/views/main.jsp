					...
					<td colspan="3">
						...
						<div id="pop_info_<%=index%>" class="pop_wrap" style="display: none;" >
							<div class="pop_inner">
								...
								<c:if test="${(list.homepageUrl).substring(0,4)=='http'}"><p class="dsc4">홈페이지 : <a id="clickdetail" href="${list.homepageUrl}">${list.homepageUrl}</a></p></c:if>
								<c:if test="${(list.homepageUrl).substring(0,4)!='http'}"><p class="dsc4">홈페이지 : <a id="clickdetail" href="https://${list.homepageUrl}">${list.homepageUrl}</a></p></c:if>
